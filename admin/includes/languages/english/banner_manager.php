...
define('TEXT_BANNERS_INSERT_NOTE', '<strong>Image Notes:</strong><ul><li>Uploading directories must have proper user (write) permissions setup!</li><li>When changing an old image, first delete the text from the path textbox.</li><li>Be sure to first prepare your images and give them a proper size and quality.</li></ul>');
