<div class="main_content_wide">
	<div class="content_box">
		...
		if ($row == 1) {
		?>
			<p>It seems no games are added for this platform yet.</p>
		<?php
		}
		?>
	</div>
